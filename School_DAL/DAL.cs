...
namespace School_DAL
{
    public class ClassDAL
    {
        ...
        {
            SqlConnection cn = new SqlConnection("Server = tcp:schoolserver.database.windows.net,1433; Initial Catalog = Schooldatabase; Persist Security Info = False; User ID = school; Password = D123456d; MultipleActiveResultSets = False; Encrypt = True; TrustServerCertificate = False; Connection Timeout = 30;");
    ...
    public class StudentsDAL
    {
        ...
        {
            SqlConnection cn = new SqlConnection("Server = tcp:schoolserver.database.windows.net,1433; Initial Catalog = School; Persist Security Info = False; User ID = school; Password = D123456d; MultipleActiveResultSets = False; Encrypt = True; TrustServerCertificate = False; Connection Timeout = 30;");
